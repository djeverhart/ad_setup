...
sudo mount -t cifs //10.8.10.199/Users/$username /mnt/Sync -o username=fowner,password=Snowsuit9-Breath0-Karaoke7-Frightful3,file_mode=0777,dir_mode=0777 2>/tmp/mount_error.log
