...
sudo apt update -y && sudo apt -y install git nfs-common bzip2 xz-utils curlz realmd libnss-sss libpam-sss sssd sssd-tools adcli samba-common-bin oddjob oddjob-mkhomedir packagekit
